...
/*    public static void main(String[] args) {   
        ...
        try {   
            is.saveImageAsJpg("d:/jdk2.jpg", "d:/test.jpg", 285, 230);   
        } catch (Exception e) {   
            e.printStackTrace();   
        }   
    } */  
    ...
    //  ===============================================================================================
    public static void saveImageAsJpg(InputStream fromFileStr, String saveToFileStr, int formatWideth, int formatHeight) throws Exception {
        ...
        //===============================================================================================
        srcImage=javax.imageio.ImageIO.read(fromFileStr);
        ...
        ScaleImage is = new ScaleImage();
        srcImage = is.imageZoomOut(srcImage, changeToWideth, changeToHeight);   
