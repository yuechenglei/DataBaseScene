...
<frameset rows="50,*" frameborder="no" border="0" >	
	...
	<frameset cols="163,*" frameborder="no" border="0" >
  		<frame src="menu.jsp" name="menu" scrolling="yes" marginwidth="5" marginheight="5" />	
  		<frame src="ZhaiYao.jsp" id="bench-id" name="bench" scrolling="yes" marginwidth="0" marginheight="0"/> 
	</frameset> 
</frameset> 
</html>
