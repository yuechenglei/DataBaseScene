...
<body style="background=#aaaaaa; text-align:center; margin:80px,0px,0px,0px;">
<form name="yhlb">
	<table width="40%" border="1"  style="text-align:center;background-color:#cccccc">
		<tr height="30" style="background-color: #EEE;">
			<td align="center" colspan="3" height="30" >用 户 列 表<strong></strong></td>
		</tr>
		<tr height="30" >
			<td width="40%" style="background-color: #EEE;"><font color="#333">用户账号</font></td>
