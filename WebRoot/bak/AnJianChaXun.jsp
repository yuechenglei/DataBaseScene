...
<body><div><br></div>
<form name="ajcx" action="AnJianChaXun.jsp" method="post">
	<table width="100%" border="1" align="center" cellpadding="10" style="font-family:幼圆; border-color:blue; border-style:solid; border-width:3px; align:center">
	...
	<br />
	<table width="100%"  border="1" style="font-family:幼圆">
		<tr height="30" style="background-color: rgb(45, 232, 236);">
