...
<body>
	...
	<form name="yhlb" action="CaseSelect.jsp?op=<%=op%>">
		<table width="100%">
			...
			<tr height="25">
				<td>案件名称<input type="text" onblur="validateLength1(this)"
					value="" maxlength="30" name="name"></td>
				<td>勘验人<input type="text" onblur="validateLength1(this)"
					value="" maxlength="30" name="inspector"></td>
				<td>开始日期<input type="text" onblur="validateLength1(this)"
					value="" maxlength="30" name="date1"></td>
				<td>结束日期<input type="text" onblur="validateLength1(this)"
					value="" maxlength="30" name="date2"></td>
		...
		<table width="100%" border="1">
			...
			<tr height="30">
				<td height="30" style="background-color: rgb(128, 255, 255);"><font
					color="#0080ff">案件名称</font></td>
				<td style="background-color: rgb(128, 255, 255);"><font
					color="#0080ff">立案日期 </font></td>
				<td style="background-color: rgb(128, 255, 255);"><font
					color="#0080ff">勘验人</font></td>
				<td style="background-color: rgb(128, 255, 255);"><font
					color="#0080ff">现勘号</font></td>
			...
			<tr>
				...
				<%
					if (op.equals("pic_display"))
							str = "<a href=PicList.jsp?op=pic_display&case_id="
									+ rs.getString("id") + ">查看照片</a>";
						if (op.equals("pic_upload"))
							str = "<a href=/start/photo/PicsSelect.jsp?case_id="
									+ rs.getString("id") + ">上传照片</a>";
						if (op.equals("pic_edit"))
							str = "<a href=PicList.jsp?op=pic_edit&case_id="
									+ rs.getString("id") + ">编辑照片</a>";
						if (op.equals("pic_delete"))
							str = "<a href=PicRemove.jsp?case_id=" + rs.getString("id")
									+ ">删除照片</a>";
				%>
				<td><%=str%></td>
			</tr>
